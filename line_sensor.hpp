...
//    void line_sensor_init() {
//        int senmax[NUM_SEN] = {800,800,800,800,800};
//        int senmin[NUM_SEN] = {200,200,200,200,200};
//        memcpy(&_sens_max, &senmax, sizeof(_sens_max)/sizeof(_sens_max[0]));
//        memcpy(&_sens_min, &senmin, sizeof(_sens_min)/sizeof(_sens_min[0]));
//
//        Serial.println("line sensor inited");
//    }
//
